...
export default function ProfileSidebar({ links, interests }: ProfileSidebarProps) {
    return (
        <aside className="space-y-6 xl:space-y-8">
            <section className="space-y-3 xl:space-y-4">
                <h2 className="text-base font-bold text-BBNDarkGreen xl:text-xl">Links</h2>
            ...
            {interests.length > 0 && (
                <section className="space-y-3 xl:space-y-4">
                    <h2 className="text-base font-bold text-BBNDarkGreen xl:text-xl">Interests</h2>
