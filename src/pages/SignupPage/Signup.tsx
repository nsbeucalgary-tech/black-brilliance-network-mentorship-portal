...
function SignupComponent({ onBack, embedded = false }: SignupProps = {}) {
...
export default function Signup({ onBack, embedded = false }: SignupProps = {}) {
  return (
    <PublicOnlyRoute>
      <SignupComponent onBack={onBack} embedded={embedded} />
    </PublicOnlyRoute>
  );
}
